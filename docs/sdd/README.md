...
| [`04-test-strategy.md`](04-test-strategy.md) | Definir integração, frontend, E2E, Docker e gates. | 121 integrações, 70 testes frontend, 3 E2E, Stryker e `SPEC-OAS-006`/`OPS-RATE-001/002` aprovados localmente; os oráculos de configuração/headers/corpo do limiter foram fortalecidos após revisão. |
| [`05-execution-plan.md`](05-execution-plan.md) | Organizar a implementação incremental em M1–M6 e atividades de qualidade posteriores. | M1–M6 e atividades posteriores, inclusive rate limiting e a correção dos seus oráculos, concluídos localmente. |
...
| [`07-validation-report.md`](07-validation-report.md) | Registrar a auditoria final independente. | Concluído com adendos pós-M6, inclusive a validação real e o fechamento da revisão do rate limiting local. |
